...
<div class="w3-col w3-twothird margin-left-large">
	
	<div class="w3-container w3-round w3-margin" onClick="check_like(<?php echo $post->post_id; ?>, <?php echo $_SESSION['user_id']; ?>)"><br>
